<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="trangchu.aspx.cs" Inherits="WebBanDienThoai.trangchu" %>
...
<body>
    ...
    <div class="menu">
        <div class="header">
            <div class="logo">
                <a href="trangchu.html"><img alt="Digiphone logo" src="img/logo/STORE.png" /></a>
            </div>
        ...
        <ul class="nav-bar">
            ...
            <li class="nav-item">
                ...
                <span><%=listDM[i].TEN_DANHMUC %></span>
                <ul class="submenu">
                    <li><a href="#">Điện thoại 1</a></li>
                    <li><a href="#">Điện thoại 2</a></li>
                    <li><a href="#">Điện thoại 3</a></li>
                </ul>
            </li>
            <% } %>
